...
def main():
    uncorrupted = KNN(name="Uncorrupted", data_file_path="data/MNIST-5-6-Subset.txt", output_path="output/uncorrupted", n_values=[10, 20, 40, 80])
    ...
    light_corruption = KNN(
        ...
        output_path="output/light_corruption",
        n_values=[80],
        skip_variance=True,
    )
    ...
    moderate_corruption = KNN(
        ...
        output_path="output/moderate_corruption",
        n_values=[80],
        skip_variance=True,
    )
    ...
    heavy_corruption = KNN(
        ...
        output_path="output/heavy_corruption",
        n_values=[80],
        skip_variance=True,
    )
