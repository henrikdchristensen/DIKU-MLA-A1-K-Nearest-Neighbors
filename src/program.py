...
def main():
    ...
    n_values = [80]
    do_validation(light_corruption_data, labels, m, n_values, num_validation_sets, light_corruption_output_path)
    ...
    n_values = [80]
    do_validation(moderate_corruption_data, labels, m, n_values, num_validation_sets, moderate_corruption_output_path)
    ...
    n_values = [80]
    do_validation(heavy_corruption_data, labels, m, n_values, num_validation_sets, heavy_corruption_output_path)
